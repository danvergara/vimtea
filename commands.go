...
func registerBindings(m *editorModel) {
	// NORMAL MODE.
	m.registry.RegisterKey(m.keyMap.Normal.EnterInsertMode, enterModeInsert, ModeNormal)
	m.registry.RegisterKey(m.keyMap.Normal.BeginVisualSelection, beginVisualSelection, ModeNormal)
	m.registry.RegisterKey(m.keyMap.Normal.BeginVisualLineSelection, beginVisualLineSelection, ModeNormal)
	m.registry.RegisterKey(m.keyMap.Normal.DeleteCharAtCursor, deleteCharAtCursor, ModeNormal)
	if m.enableCommandMode {
		m.registry.RegisterKey(m.keyMap.Normal.EnterModeCommand, enterModeCommand, ModeNormal)
	}

	m.registry.RegisterKey(m.keyMap.Normal.AppendAfterCursor, appendAfterCursor, ModeNormal)
	m.registry.RegisterKey(m.keyMap.Normal.AppendAtEndOfLine, appendAtEndOfLine, ModeNormal)
	m.registry.RegisterKey(m.keyMap.Normal.InsertatStartOfLine, insertAtStartOfLine, ModeNormal)
	m.registry.RegisterKey(m.keyMap.Normal.OpenLineBelow, openLineBelow, ModeNormal)
	m.registry.RegisterKey(m.keyMap.Normal.OpenLineAbove, openLineAbove, ModeNormal)

	m.registry.RegisterKey(m.keyMap.Normal.YankLine, yankLine, ModeNormal)
	m.registry.RegisterKey(m.keyMap.Normal.DeleteLine, deleteLine, ModeNormal)
	m.registry.RegisterKey(m.keyMap.Normal.DeleteToEndOfLine, deleteToEndOfLine, ModeNormal)
	m.registry.RegisterKey(m.keyMap.Normal.PasteAfter, pasteAfter, ModeNormal)
	m.registry.RegisterKey(m.keyMap.Normal.PasteBefore, pasteBefore, ModeNormal)

	m.registry.RegisterKey(m.keyMap.Normal.Undo, undo, ModeNormal)
	m.registry.RegisterKey(m.keyMap.Normal.Redo, redo, ModeNormal)
	m.registry.RegisterKey(m.keyMap.Normal.DeleteInnerWord, deleteInnerWord, ModeNormal)
	m.registry.RegisterKey(m.keyMap.Normal.YankInnerWord, yankInnerWord, ModeNormal)
	m.registry.RegisterKey(m.keyMap.Normal.ChangeInnerWord, changeInnerWord, ModeNormal)

	m.registry.RegisterKey(m.keyMap.Normal.MoveCursorLeft, moveCursorLeft, ModeNormal)
	m.registry.RegisterKey(m.keyMap.Normal.MoveCursorDown, moveCursorDown, ModeNormal)
	m.registry.RegisterKey(m.keyMap.Normal.MoveCursorUp, moveCursorUp, ModeNormal)
	m.registry.RegisterKey(m.keyMap.Normal.MoveCursorRight, moveCursorRight, ModeNormal)

	m.registry.RegisterKey(m.keyMap.Normal.MoveToNextWordStart, moveToNextWordStart, ModeNormal)
	m.registry.RegisterKey(m.keyMap.Normal.MoveToPrevWordStart, moveToPrevWordStart, ModeNormal)

	m.registry.RegisterKey(m.keyMap.Normal.MoveCursorRightOrNextLine, moveCursorRightOrNextLine, ModeNormal)
	m.registry.RegisterKey(m.keyMap.Normal.MoveToStartOfLine, moveToStartOfLine, ModeNormal)
	m.registry.RegisterKey(m.keyMap.Normal.MoveToFirstNonWhitespace, moveToFirstNonWhitespace, ModeNormal)
	m.registry.RegisterKey(m.keyMap.Normal.MoveToEndOfLine, moveToEndOfLine, ModeNormal)
	m.registry.RegisterKey(m.keyMap.Normal.MoveToStartOfDocument, moveToStartOfDocument, ModeNormal)
	m.registry.RegisterKey(m.keyMap.Normal.MoveToEndOfDocument, moveToEndOfDocument, ModeNormal)

	// VISUAL MODE.
	m.registry.RegisterKey(m.keyMap.Visual.MoveCursorLeft, moveCursorLeft, ModeVisual)
	m.registry.RegisterKey(m.keyMap.Visual.MoveCursorDown, moveCursorDown, ModeVisual)
	m.registry.RegisterKey(m.keyMap.Visual.MoveCursorUp, moveCursorUp, ModeVisual)
	m.registry.RegisterKey(m.keyMap.Visual.MoveCursorRight, moveCursorRight, ModeVisual)

	m.registry.RegisterKey(m.keyMap.Visual.MoveToNextWordStart, moveToNextWordStart, ModeVisual)
	m.registry.RegisterKey(m.keyMap.Visual.MoveToPrevWordStart, moveToPrevWordStart, ModeVisual)

	m.registry.RegisterKey(m.keyMap.Visual.MoveCursorRightOrNextLine, moveCursorRightOrNextLine, ModeVisual)
	m.registry.RegisterKey(m.keyMap.Visual.MoveToStartOfLine, moveToStartOfLine, ModeVisual)
	m.registry.RegisterKey(m.keyMap.Visual.MoveToFirstNonWhitespace, moveToFirstNonWhitespace, ModeVisual)
	m.registry.RegisterKey(m.keyMap.Visual.MoveToEndOfLine, moveToEndOfLine, ModeVisual)
	m.registry.RegisterKey(m.keyMap.Visual.MoveToStartOfDocument, moveToStartOfDocument, ModeVisual)
	m.registry.RegisterKey(m.keyMap.Visual.MoveToEndOfDocument, moveToEndOfDocument, ModeVisual)

	m.registry.RegisterKey(m.keyMap.Visual.ExitModeVisual, exitModeVisual, ModeVisual)
	m.registry.RegisterKey(m.keyMap.Visual.EnterModeCommand, enterModeCommand, ModeVisual)
	m.registry.RegisterKey(m.keyMap.Visual.YankVisualSelection, yankVisualSelection, ModeVisual)
	m.registry.RegisterKey(m.keyMap.Visual.DeleteVisualSelection, deleteVisualSelection, ModeVisual)
	m.registry.RegisterKey(m.keyMap.Visual.ReplaceVisualSelectionWithYank, replaceVisualSelectionWithYank, ModeVisual)

	// INSERT MODE.
	m.registry.RegisterKey(m.keyMap.Insert.ExitModeInsert, exitModeInsert, ModeInsert)
	m.registry.RegisterKey(m.keyMap.Insert.HandleInsertBackspace, handleInsertBackspace, ModeInsert)
	m.registry.RegisterKey(m.keyMap.Insert.HandleInsertTab, handleInsertTab, ModeInsert)
	m.registry.RegisterKey(m.keyMap.Insert.HandleInsertEnterKey, handleInsertEnterKey, ModeInsert)
	m.registry.RegisterKey(m.keyMap.Insert.MoveUp, handleArrowKeys("up"), ModeInsert)
	m.registry.RegisterKey(m.keyMap.Insert.MoveDown, handleArrowKeys("down"), ModeInsert)
	m.registry.RegisterKey(m.keyMap.Insert.MoveLeft, handleArrowKeys("left"), ModeInsert)
	m.registry.RegisterKey(m.keyMap.Insert.MoveRight, handleArrowKeys("right"), ModeInsert)

	// COMMAND MODE.
	m.registry.RegisterKey(m.keyMap.Command.ExitModeCommand, exitModeCommand, ModeCommand)
	m.registry.RegisterKey(m.keyMap.Command.ExecuteModeCommand, executeCommand, ModeCommand)
	m.registry.RegisterKey(m.keyMap.Command.CommandBackspace, commandBackspace, ModeCommand)
